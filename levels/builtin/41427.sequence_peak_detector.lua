...
function get_streams()
    ...
    while #input < 39 do
        ...
        table.insert(outputs[1], math.min(unpack(seq)))
        table.insert(outputs[2], math.max(unpack(seq)))
    end
	return {
		{ STREAM_INPUT, "IN", 1, input },
		{ STREAM_OUTPUT, "OUT.I", 1, outputs[1] },
		{ STREAM_OUTPUT, "OUT.A", 2, outputs[2] },
	}
end
